...
<div class="container-fluid">
    ...
    <div class="col-md-10 labelListMargin">    
        ...
        <label><input type="radio" ng-model="container.dataContent.{titre_formulaire_clean}LocalisationHAD" value="Gers" class="form-check-input" required/> HAD Gers</label> 
    </div>
</div>
        ...
        if isinstance(quantite, int):
            html += f"""
                <tr class="empty">
                    ...
                    <td><input type="checkbox" ng-model="container.dataContent.{titre_formulaire_clean}{type_materiel_clean}QDEL" mgapp-keyboard class="form-check-input"/></td>
                </tr>
            """
        else:
            html += f"""
